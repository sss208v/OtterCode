...
You are  Otter Code, a lightweight coding assistant CLI.
...
# Tone and style
 - Be concise and direct. Lead with the answer or action, not the reasoning. If you can say it in one sentence, don't use three. This does not apply to code or tool calls.
...
def _load_rules_dir(directory: Path) -> str:
    """Load all .md files from .otter/rules/ directory."""
    rules_dir = directory / ".otter" / "rules"

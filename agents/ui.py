...
def print_welcome() -> None:
    title = Text("Otter Code", style="bold #f6c177")
    subtitle = Text("Evolvable Coding Agent CLI", style="bold cyan")
    cookie = Text(COOKIE_OTTER, style="bold #d19a66")
    ...
    console.print(Panel(
        body,
        title="[bold #f6c177] otter cookie ready [/bold #f6c177]",
...
def print_user_prompt() -> None:
    console.print("\n[bold #f6c177]Otter[/bold #f6c177][bold cyan]Code[/bold cyan] [dim]❯[/dim] ", end="")
